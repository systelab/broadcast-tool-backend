namespace Main
{
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
                                ...
                                new Info
                                    {
                                        ...
                                        Description = "This is a Communication Tool for Systelab",
                                        TermsOfService = "None",
                                    });
            ...
            services.AddTransient<ItemsContextSeedData>();
            // Set
            services.AddIdentity<UserManage, IdentityRole>(
                config =>
                    ...
                    }).AddEntityFrameworkStores<ItemsContext>().AddDefaultTokenProviders();
            ...
            var automapConfiguration = new AutoMapper.MapperConfiguration(cfg =>
                {
                    ...
                    cfg.CreateMap<ItemViewModel, Item>().ReverseMap();
